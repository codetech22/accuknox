...
const StockDisplay = ({ stockName, data, days }) => {
  ...
  return (
    <div className='bg-gradient-to-r from-pink-200 to-fuchsia-100'>
      ...
      <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 sm:text-sm text-xl">
        <thead>
          <tr>
        ...
        <tbody className='divide-y divide-gray-200 dark:divide-gray-700'>
          {filteredData.map((item, index) => {
            ...
            return (
              <tr key={index} className='hover:bg-gray-100 text-lg md:text-xl'>
...
const Stocks = () => {
  ...
  return (
    ...
    <div className='bg-gradient-to-r from-pink-200 to-fuchsia-100 max-h-full overflow-hidden h-[900px]'>
       <div className='p-3'>
